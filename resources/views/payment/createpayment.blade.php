                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h2 class="card-title">TAMBAH Payment</h2>
                            </div>
                            <div class="card-body">
                             <a href="{{ route('payment') }} "><button class="btn btn-danger">kembali</button></a>
                            </div>
                            <div class="card-body">
                                 <form method="post" action="{{route('createpayments')}}" enctype="  multipart/form-data">
                                        {{csrf_field()}}
                                <div class="row">
                                        <div class="col-xl-6 col-md-8 col-12 mb-1">

                                            <div class="form-group">
                                                <label for="waktu">Name</label>
                                                <input type="text"  class="form-control" name="payment_name" id="payment_name" placeholder="" required="" />
                                            </div>
